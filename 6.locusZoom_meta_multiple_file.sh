...
Rscript-4.1 /home/rhdfyd/code/pipeline_QTL/summarize.R $taxa_dir/LDSC/mbQTL_signal_5e-8.txt $dist $flank ${output_dir} ${taxa_name} 5e-8

mkdir $taxa_dir/overlapped_w_knownLoci_result
Rscript-4.1 /home/rhdfyd/code/pipeline_QTL/Overlap_checking_for_QTL.R $output_dir/associated_region.summary_${taxa_name}_$dist-5e-8 $taxa_dir/overlapped_w_knownLoci_result
...
/kimlab_wd/rhdfyd/tools/locuszoom/bin/locuszoom \
